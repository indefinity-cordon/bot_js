...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let bot_settings = await client.databaseRequest({ database: global.database, query: "SELECT param FROM settings WHERE name = 'main_server'", params: []})
        ...
        if (db_response[0] && db_response[0].discord_id) {
            ...
            bot_settings = await client.databaseRequest({ database: global.database, query: "SELECT param FROM settings WHERE name = 'verified_role'", params: []})
